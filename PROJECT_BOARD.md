...
- [x] vol/svi.py — SVI calibration  
  ...
  - Returns `SVIFit` with params, loss, and notes; works with preprocess outputs.
  </details>
...
- [x] notebooks/SVI_Test.ipynb — SVI calibration test  
  Owner: Drew · Tags: 📦  
  <details><summary>What shipped</summary>
  
  - Builds (k, w, weights) from preprocessed quotes, fits SVI, overlays IVs, runs butterfly check, saves artifacts.
  </details>
