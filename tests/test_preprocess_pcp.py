import numpy as np
import pandas as pd
from preprocess.pcp import synth_put_from_call, synth_call_from_put, pcp_residual, add_pcp_diagnostics
...
def test_pcp_dataframe_helpers():
    ...
    diag = add_pcp_diagnostics(df, spot=S, r=r, T=T, q=0.0, price_col="mid", type_col="type", strike_col="strike")
